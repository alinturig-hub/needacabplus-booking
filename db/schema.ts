...
export const bookings=sqliteTable('bookings',{
 id:text('id').primaryKey(),userId:text('user_id').notNull(),name:text('name').notNull(),phone:text('phone').notNull(),pickup:text('pickup').notNull(),destination:text('destination').notNull(),pickupNote:text('pickup_note').notNull(),vehicle:text('vehicle').notNull(),farePence:integer('fare_pence').notNull(),status:text('status').notNull().default('test_confirmed'),createdAt:text('created_at').notNull(),
