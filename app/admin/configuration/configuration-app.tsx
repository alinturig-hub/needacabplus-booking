...
export default function ConfigurationApp(){
 return <main className="admin-shell">
  <header className="brandbar">
   ...
   <nav className="admin-nav" aria-label="Admin navigation"><Link href="/admin">Bookings</Link><Link href="/admin/drivers">Drivers</Link><Link href="/admin/vehicles">Vehicles</Link><Link href="/admin/live-map">Clear Map</Link><Link className="active" href="/admin/configuration">Configuration</Link></nav>
